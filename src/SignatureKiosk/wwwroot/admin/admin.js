  ...
  function размерыТекста(сцена, ф) {
    ...
    watch.сводка = н
      ? ("Кегли: у клиента " + (н.base || "?") + " и " + (н.text || "?")
         ...
         + ". Ширина тела: " + (н.bodyW || "?") + " и " + Math.round(ф.w - 2 * (parseFloat(сцена.style.getPropertyValue("--wt-pad")) || 0))
